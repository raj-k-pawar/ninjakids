...
import '../../../widgets/parent/kid_card.dart';
import '../../../widgets/parent/weekly_chart.dart';
import '../../../widgets/parent/subject_performance_bar.dart';
import '../../../widgets/common/screen_time_ring.dart';
...
class _ParentDashboardScreenState extends ConsumerState<ParentDashboardScreen> {
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () => setState(() => _selectedKidIndex = index),
                        child: _buildKidChip(
                          kids[index],
          ...
          if (selectedKid != null) ...[
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: _buildScreenTimeCard(selectedKid),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _buildQuizStatsCard(selectedKid),
                  ),
                ],
              ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      TextButton(
                        onPressed: () => context.push(Routes.parentAnalytics),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Center(
              child: Text(kid.avatarEmoji, style: const TextStyle(fontSize: 24)),
            ),
          ),
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: isNearLimit ? const Color(0xFF92660A) : AppTheme.darkNavy,
            ),
          ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                isNearLimit ? AppTheme.accentOrange : AppTheme.accentGreen,
              ),
            ),
          ),
          const SizedBox(height: 4),
  ...
  Widget _buildAnalyticsTab(KidEntity? kid) {
    if (kid == null) return const Center(child: Text('Select a child first'));
