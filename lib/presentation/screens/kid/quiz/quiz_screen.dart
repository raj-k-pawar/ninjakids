...
class _QuizScreenState extends ConsumerState<QuizScreen>
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      ...
      final questions = await service.generateQuestions(
        ...
        className: 'Class 5', // TODO: fetch from kid profile
  ...
  void _startTimer() {
    ...
    _timerController.addListener(() {
      final remaining = (_secondsPerQuestion * (1 - _timerController.value)).ceil();
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            ).animate(key: ValueKey(_currentIndex)).fadeIn(duration: 300.ms).scale(
