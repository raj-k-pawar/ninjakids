...
class Badge {
  ...
  static List<Badge> get allBadges => [
    const Badge(id: 'first_quiz', name: 'First Strike', description: 'Complete your first quiz', emoji: '⚡', type: BadgeType.achievement),
    const Badge(id: 'streak_3', name: '3-Day Ninja', description: '3-day learning streak', emoji: '🔥', coinsReward: 100, type: BadgeType.streak),
    const Badge(id: 'streak_7', name: 'Week Warrior', description: '7-day learning streak', emoji: '⚔️', coinsReward: 250, type: BadgeType.streak),
    const Badge(id: 'math_master', name: 'Math Master', description: 'Score 100% in Math quiz', emoji: '🔢', coinsReward: 150, type: BadgeType.subject),
    const Badge(id: 'english_pro', name: 'English Pro', description: 'Complete 10 English lessons', emoji: '📖', coinsReward: 150, type: BadgeType.subject),
    const Badge(id: 'quiz_100', name: 'Century Club', description: 'Complete 100 quizzes', emoji: '💯', coinsReward: 500, type: BadgeType.milestone),
    const Badge(id: 'speed_demon', name: 'Speed Demon', description: 'Answer in under 5 seconds', emoji: '💨', coinsReward: 100, type: BadgeType.achievement),
    const Badge(id: 'perfect_score', name: 'Perfect Ninja', description: 'Get perfect score in a quiz', emoji: '🥷', coinsReward: 200, type: BadgeType.achievement),
  ];
}
