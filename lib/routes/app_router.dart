...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final authPages = [AppRoutes.splash, AppRoutes.parentLogin, AppRoutes.parentRegister, AppRoutes.childPinDirect];
      final isAuthPage = authPages.contains(loc);

      if (authState.isLoggedIn && authState.isParent && isAuthPage) {
