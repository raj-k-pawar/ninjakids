          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [_gradeColors.first.withOpacity(0.15), Colors.white],
                    ...
                    ScaleTransition(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: _gradeColors.first.withOpacity(0.4),
                              blurRadius: 24,
                              spreadRadius: 6,
                            ),
                          ],
                    ...
                    AnimatedCard(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Correct Answers',
                            style: GoogleFonts.nunito(fontSize: 14, color: Colors.white.withOpacity(0.8)),
                          ),
