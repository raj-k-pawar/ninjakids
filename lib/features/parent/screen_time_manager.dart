...
class _ScreenTimeManagerState extends ConsumerState<ScreenTimeManager> {
  ...
  bool _appLock = true;
  final int _breakInterval = 30;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const NinjaAppBar(title: '⏰ Screen Time'),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Today's usage
            AnimatedCard(
              gradientColors: const [AppColors.blue, Color(0xFF0099CC)],
              child: Column(
                children: [
            ...
            const SectionHeader(title: 'Daily Limit'),
            const SizedBox(height: 12),
            AnimatedCard(
              child: Column(
                children: [
            ...
            const SectionHeader(title: 'Study Schedule'),
            const SizedBox(height: 12),
            AnimatedCard(
              child: Column(
                children: [
            ...
            const SectionHeader(title: 'App Controls'),
            const SizedBox(height: 12),
            AnimatedCard(
              child: Column(
                children: [
...
class _SubjectAccessScreenState extends ConsumerState<SubjectAccessScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const NinjaAppBar(title: '📗 Subject Access'),
      body: Column(
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
            child: AnimatedCard(
              gradientColors: const [AppColors.green, Color(0xFF00A86B)],
              child: Row(
                children: [
...
class ProgressAnalyticsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: const NinjaAppBar(title: '📊 Progress Report'),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      const StatChip(emoji: '⏱️', value: '6h 30m', label: 'Learning\nTime', color: AppColors.blue),
                      const SizedBox(height: 8),
                      const StatChip(emoji: '✅', value: '83%', label: 'Quiz\nAccuracy', color: AppColors.green),
                    ],
                  ),
                ),
              ],
