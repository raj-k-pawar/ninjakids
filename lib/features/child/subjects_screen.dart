...
class SubjectsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: NinjaAppBar(title: '📚 Subjects', showBack: true),
      body: Column(
        children: [
          // Banner
          Padding(
            ...
            child: AnimatedCard(
              gradientColors: [AppColors.primary, const Color(0xFF9C63FF)],
              child: Row(
                children: [
...
class _GamesScreenState extends ConsumerState<GamesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: NinjaAppBar(title: '🎮 Games'),
      body: Column(
        children: [
          // Subject tabs
          SizedBox(
...
class RewardsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final children = ref.watch(childrenProvider);
    final child = auth.activeChild ?? (children.isNotEmpty ? children.first : null);
    final badges = Badge.allBadges;

    return Scaffold(
      appBar: NinjaAppBar(title: '🏆 Rewards & Achievements'),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SectionHeader(title: '🥋 Ninja Badges'),
            const SizedBox(height: 12),
            GridView.builder(
              shrinkWrap: true,
            ...
            // Daily streak card
            AnimatedCard(
              gradientColors: [const Color(0xFFFF6B35), const Color(0xFFFFB84C)],
              child: Row(
                children: [
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Avatar change
                  SectionHeader(title: '🥷 Change Avatar'),
                  const SizedBox(height: 12),
                  SizedBox(
                    height: 80,
