      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [gradientColors.first.withValues(alpha: 0.1), isDark ? AppColors.bgDark : Colors.white],
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (_, child) => Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: (_isListening ? AppColors.red : gradientColors.first).withValues(alpha: 0.4),
