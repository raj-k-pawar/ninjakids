...
class _ParentLoginScreenState extends ConsumerState<ParentLoginScreen>
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Your child's learning", style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                                Text('journey starts here! 🚀', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                                const SizedBox(height: 6),
                                Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 3),
                                  decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(10)),
                                  child: Text('AI-Powered Learning', style: GoogleFonts.nunito(fontSize: 11, color: Colors.white)),
                                ),
                              ],
                            ),
                          ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'After logging in, tap a child\'s avatar on the dashboard to let them sign in with their PIN.',
                              style: GoogleFonts.nunito(fontSize: 12, color: isDark ? Colors.white70 : AppColors.textDark, height: 1.4),
                            ),
                          ),
                        ],
                      ),
                    ...
                    GradientButton(text: 'Login', isLoading: auth.isLoading, onTap: _login),
                    ...
                    Row(children: [
                      ...
                      Padding(
                        ...
                        child: Text('or continue with', style: GoogleFonts.nunito(fontSize: 13, color: AppColors.textGrey)),
                      ),
                      Expanded(child: Divider(color: Colors.grey.withValues(alpha: 0.3))),
                    ]),
                    ...
                    Row(children: [
                      const Expanded(child: SocialButton(label: 'Google', icon: Text('🌐', style: TextStyle(fontSize: 20)))),
                      const SizedBox(width: 12),
                      const Expanded(child: SocialButton(label: 'Apple', icon: Text('🍎', style: TextStyle(fontSize: 20)))),
                    ]),

                    const SizedBox(height: 28),

                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text("Don't have an account? ", style: GoogleFonts.nunito(fontSize: 14, color: AppColors.textGrey)),
                      GestureDetector(
                        onTap: () => context.go(AppRoutes.parentRegister),
                        child: Text('Sign Up', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.primary)),
                      ),
                    ]),
  ...
  Widget _label(String text) => Text(text, style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600));
