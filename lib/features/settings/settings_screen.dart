        ...
        child: Column(
          children: [
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: selected ? plan.color : Colors.grey.withOpacity(0.2),
                      width: selected ? 2 : 1,
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: (selected ? plan.color : Colors.black).withOpacity(0.12),
                        blurRadius: 12,
                              ...
                              children: [
                                ...
                                if (plan.isPopular) ...[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: selected ? Colors.white.withOpacity(0.25) : AppColors.secondary,
                                ...
                                if (plan.savings != null) ...[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: AppColors.green.withOpacity(selected ? 0.3 : 0.15),
                            ...
                            Wrap(
                              ...
                              children: plan.features.take(3).map((f) => Text(
                                ...
                                style: GoogleFonts.nunito(
                                  fontSize: 11,
                                  color: selected ? Colors.white.withOpacity(0.9) : AppColors.textGrey,
                                ),
                              )).toList(),
                            ),
                          ],
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 20,
                          decoration: BoxDecoration(
                            color: _plans[_selectedPlan].color.withOpacity(0.15),
            ...
            GradientButton(
              ...
              colors: [_plans[_selectedPlan].color, _plans[_selectedPlan].color.withOpacity(0.7)],
              onTap: () {
