                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: GoogleFonts.nunito(color: AppColors.textGrey.withValues(alpha: 0.6), fontSize: 14),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.black.withValues(alpha: isUser ? 0 : 0.06),
                    blurRadius: 8,
          ...
          if (isUser) ...[
            const SizedBox(width: 8),
            const NinjaAvatar(avatarId: 'ninja1', size: 34),
          ],
        ],
      ),
    );
